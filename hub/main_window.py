...
from hub.editor import Editor
from hub.export_dialog import AdvancedExportDialog, ExportDialog
from hub.headerbars import BaseHeaderbar
from hub.helpers import App, bind_enum
from hub.panels import ApostrophePanels
from hub.preview_handler import PreviewHandler
from hub.preview_security import PreviewSecurity
from hub.search_and_replace import ApostropheSearchBar
from hub.settings import Settings
from hub.stats_handler import StatsHandler
from hub.text_view import ApostropheTextView
from hub.text_view_format_inserter import FormatInserter
from hub.preview_security import PreviewSecurityHandler
from hub.pride import apply_seasonal_style
from hub.sized_bin import ApostropheSizedBin
...
class MainWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        if self.get_application()._application_id == 'io.fede.ClaudeSessionHub.Devel':
    ...
    def show_hemingway_help(self, *args):
        hemingway_dialog = Gtk.Builder.new_from_resource("/io/fede/ClaudeSessionHub/ui/AboutHemingway.ui")\
                           .get_object("dialog")
